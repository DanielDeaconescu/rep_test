...
// Trying to close the navbar when clicking outside of it
...
$(document).ready(function () {
    $(document).click(function (event) {
        ...
        if (_open === true && !click.hasClass("navbar-toggle")) {
...
//         if(windowWidth < 1025 && windowHeight === 1366) {
//                 $(".ghj").addClass("col-md-6");
// } else
//     $(".ghj").removeClass("col-md-6");
//     })
// })
